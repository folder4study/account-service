...
// IgnoreOpenCensusWorkerLeak This prevents catching the leak generated by opencensus defaultWorker.Start which at the time is part of the package's init call.
